package com.nhhgrp.backend.mapper;

import com.nhhgrp.backend.dto.ProductDto;
import com.nhhgrp.backend.dto.ProductResourceDto;
import com.nhhgrp.backend.dto.ProductVariantDto;
...
public class ProductMapper {
    ...
    public Product mapToProductEntity(ProductDto productDto){
        ...
        if(category != null){
            ...
            CategoryType categoryType = category.getCategoryTypes().stream().filter(categoryType1 -> categoryType1.getId().equals(categoryTypeId)).findFirst()
                    .orElse(null);
